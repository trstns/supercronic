...
RUN set -ex; \
    case "${TARGETARCH}${TARGETVARIANT}" in \
        amd64) \
            ...
            SUPERCRONIC_SHA256SUM="3634b6398bedf922b6e05311a35abef69fc2650c04508a53dd613058024991e7"; `# amd64` \
            ;; \
        arm64) \
            SUPERCRONIC_URL="https://github.com/aptible/supercronic/releases/download/${SUPERCRONIC_VERSION}/supercronic-linux-arm64"; \
            SUPERCRONIC_SHA256SUM="3634b6398bedf922b6e05311a35abef69fc2650c04508a53dd613058024991e7"; `# arm64` \
            ;; \
        armv7) \
            SUPERCRONIC_URL="https://github.com/aptible/supercronic/releases/download/${SUPERCRONIC_VERSION}/supercronic-linux-arm"; \
            SUPERCRONIC_SHA256SUM="3634b6398bedf922b6e05311a35abef69fc2650c04508a53dd613058024991e7"; `# arm` \
            ;; \
        386) \
